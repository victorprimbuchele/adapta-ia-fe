...
import { AtividadeRevisaoScreen } from "./AtividadeRevisaoScreen";
...
jest.mock("../../alunos/hooks/usePerfisAprendizagem");
jest.mock("../../turmas/hooks/useTurmaDetalhe");
...
describe("AtividadeRevisaoScreen", () => {
  beforeEach(() => {
    ...
    mockedUsePerfis.mockReturnValue({ data: PERFIS } as unknown as ReturnType<typeof usePerfisAprendizagem>);

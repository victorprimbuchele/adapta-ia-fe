...
import { AtividadeProcessandoScreen } from "./AtividadeProcessandoScreen";
...
describe("AtividadeProcessandoScreen", () => {
  beforeEach(() => {
    ...
    mockedUsePerfis.mockReturnValue({
      ...
      isPending: false,
    } as unknown as ReturnType<typeof usePerfisAprendizagem>);
  });
